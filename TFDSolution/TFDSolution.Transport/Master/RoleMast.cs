...
namespace TFDSolution.Transport.Master
{
    public class RoleMast
    {
        ...
        [MaxLength(1000, ErrorMessage = "Length cannot exceed 100 Character.")]
        [RegularExpression(@"^[A-Za-z\s]{2,50}$", ErrorMessage = "Only alphabets and spaces allowed.")]
    ...
    public class RoleDetail : RoleMast
    {
        public List<RolePermission> rolePermissions { get; set; }
        public List<RoleParentForm> roleParentForms { get; set; }
    }

    public class RoleParentForm
    {
        public Guid FormId { get; set; }
        public string FormName { get; set; }
    }

    public class RolePermission: Permissions
    {
    ...
    public class API_ConversionRate
    {
    ...
    public class API_ExchangeRates
    {
        public string result { get; set; }
        public string documentation { get; set; }
        public string terms_of_use { get; set; }
