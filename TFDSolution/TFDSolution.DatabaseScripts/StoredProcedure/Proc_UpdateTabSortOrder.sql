...
CREATE OR ALTER PROCEDURE Proc_UpdateTabSortOrder
    @SortOrderTable dbo.UDT_SortOrderData READONLY
AS
-- =============================================
-- Author:		Lavina Shaktawat
-- Create date: 19/06/2025 
-- Description:	<Update Sorting Order of Tabs listed in input tabletype parameter>
-- =============================================
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        -- Update SortOrder for each Tabid from the input table
		UPDATE f
        SET f.SortOrder = s.SortOrder
		FROM m_FormTab f
        INNER JOIN @SortOrderTable s ON f.FormTabId = s.FormId;
